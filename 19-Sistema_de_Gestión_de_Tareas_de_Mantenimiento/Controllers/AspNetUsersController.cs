...
namespace _19_Sistema_de_Gestión_de_Tareas_de_Mantenimiento.Controllers
{
    ...
    public class AspNetUsersController : Controller
    {
        ...
        public AspNetUsersController(SistemaGestionContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,NroLegajo,FechaIngreso,UserName,NormalizedUserName,Email,NormalizedEmail,EmailConfirmed,PasswordHash,SecurityStamp,ConcurrencyStamp,PhoneNumber,PhoneNumberConfirmed,TwoFactorEnabled,LockoutEnd,LockoutEnabled,AccessFailedCount")] AspNetUser aspNetUser)
        {
