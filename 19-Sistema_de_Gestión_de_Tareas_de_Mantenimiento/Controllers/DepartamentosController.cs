...
namespace _19_Sistema_de_Gestión_de_Tareas_de_Mantenimiento.Controllers
{
    ...
    public class DepartamentosController : Controller
    {
        ...
        public DepartamentosController(SistemaGestionContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DepartamentoId,NombreDepartamento,JefeId")] Departamento departamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DepartamentoId,NombreDepartamento,JefeId")] Departamento departamento)
        {
