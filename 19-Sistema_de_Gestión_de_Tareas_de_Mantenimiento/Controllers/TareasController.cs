...
namespace _19_Sistema_de_Gestión_de_Tareas_de_Mantenimiento.Controllers
{
    ...
    public class TareasController : Controller
    {
        ...
        public TareasController(SistemaGestionContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("TareaId,Descripcion,FechaCreacion")] Tarea tarea)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TareaId,Descripcion,FechaCreacion")] Tarea tarea)
        {
            if (id != tarea.TareaId)
            {
                return NotFound();
